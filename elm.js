...
Elm.Encounters.make = function (_elm) {
   ...
   var route16table = {_: {}
                      ...
                      "Rattata",
                      18)
                      ,slot4: A2(encounter,"Doduo",20)
                      ,slot5: A2(encounter,
                      "Rattata",
                      20)
                      ,slot6: A2(encounter,"Doduo",18)
                      ,slot7: A2(encounter,"Doduo",22)
                      ,slot8: A2(encounter,
                      "Rattata",
                      22)
                      ,slot9: A2(encounter,
   ...
   var route17table = {_: {}
                      ...
                      "Raticate",
                      25)
                      ,slot4: A2(encounter,"Doduo",24)
                      ,slot5: A2(encounter,
                      "Raticate",
                      27)
                      ,slot6: A2(encounter,"Doduo",26)
                      ,slot7: A2(encounter,"Doduo",28)
                      ,slot8: A2(encounter,
                      "Raticate",
                      29)
                      ,slot9: A2(encounter,
   ...
   var route23table = {_: {}
                      ,name: "Route 23"
                      ,rate: 10
                      ,slot1: A2(encounter,"Ekans",26)
                      ,slot10: A2(encounter,
                      "Fearow",
                      43)
                      ,slot2: A2(encounter,"Ditto",33)
                      ,slot3: A2(encounter,
                      "Spearow",
                      26)
                      ,slot4: A2(encounter,
                      "Fearow",
                      38)
                      ,slot5: A2(encounter,"Ditto",38)
                      ,slot6: A2(encounter,
                      "Fearow",
                      38)
                      ,slot7: A2(encounter,"Arbok",41)
                      ,slot8: A2(encounter,"Ditto",43)
                      ,slot9: A2(encounter,
                      "Fearow",
                      41)};
   var route24table = {_: {}
                      ,name: "Route 24"
                      ,rate: 25
                      ,slot1: A2(encounter,"Weedle",7)
                      ,slot10: A2(encounter,"Abra",12)
                      ,slot2: A2(encounter,"Kakuna",8)
                      ,slot3: A2(encounter,
                      "Pidgey",
                      12)
                      ,slot4: A2(encounter,
                      ...
                      "Pidgey",
                      13)
                      ,slot9: A2(encounter,"Abra",8)};
   var route25table = {_: {}
                      ,name: "Route 25"
                      ,rate: 15
                      ,slot1: A2(encounter,"Weedle",8)
                      ,slot10: A2(encounter,
                      "Caterpie",
                      8)
                      ,slot2: A2(encounter,"Kakuna",9)
                      ,slot3: A2(encounter,
                      "Pidgey",
                      13)
                      ,slot4: A2(encounter,
                      ...
                      "Oddish",
                      13)
                      ,slot6: A2(encounter,"Abra",12)
                      ,slot7: A2(encounter,
                      "Oddish",
                      14)
                      ,slot8: A2(encounter,"Abra",10)
                      ,slot9: A2(encounter,
                      "Metapod",
                      7)};
   var viridianForestTable = {_: {}
                             ,name: "Viridian Forest"
                             ,rate: 8
                             ,slot1: A2(encounter,"Weedle",4)
                             ,slot10: A2(encounter,
                             "Pikachu",
                             5)
                             ,slot2: A2(encounter,"Kakuna",5)
                             ,slot3: A2(encounter,"Weedle",3)
                             ,slot4: A2(encounter,"Weedle",5)
                             ,slot5: A2(encounter,"Kakuna",4)
                             ,slot6: A2(encounter,"Kakuna",6)
                             ,slot7: A2(encounter,
                             "Metapod",
                             4)
                             ,slot8: A2(encounter,
   ...
   var mtMoonTable1 = {_: {}
                      ,name: "Mt. Moon (1F)"
                      ,rate: 10
                      ,slot1: A2(encounter,"Zubat",8)
                      ,slot10: A2(encounter,
                      "Clefairy",
                      8)
                      ,slot2: A2(encounter,"Zubat",7)
                      ,slot3: A2(encounter,"Zubat",9)
                      ,slot4: A2(encounter,
                      "Geodude",
                      8)
                      ,slot5: A2(encounter,"Zubat",6)
                      ,slot6: A2(encounter,"Zubat",10)
                      ,slot7: A2(encounter,
                      "Geodude",
                      10)
                      ,slot8: A2(encounter,"Paras",8)
                      ,slot9: A2(encounter,
                      "Zubat",
                      11)};
   var mtMoonTable2 = {_: {}
                      ...
                      "Geodude",
                      8)
                      ,slot5: A2(encounter,"Zubat",9)
                      ,slot6: A2(encounter,"Paras",10)
                      ,slot7: A2(encounter,"Zubat",10)
                      ,slot8: A2(encounter,"Zubat",11)
                      ,slot9: A2(encounter,
                      "Clefairy",
                      9)};
   var mtMoonTable3 = {_: {}
                      ...
                      "Geodude",
                      9)
                      ,slot3: A2(encounter,"Zubat",10)
                      ,slot4: A2(encounter,
                      "Geodude",
                      10)
                      ,slot5: A2(encounter,"Zubat",11)
                      ,slot6: A2(encounter,"Paras",10)
                      ,slot7: A2(encounter,"Paras",12)
                      ,slot8: A2(encounter,
                      "Clefairy",
                      10)
                      ,slot9: A2(encounter,
                      "Zubat",
                      12)};
   var rockTunnelTable1 = {_: {}
                          ,name: "Rock Tunnel (1F)"
                          ,rate: 15
                          ,slot1: A2(encounter,"Zubat",16)
                          ,slot10: A2(encounter,"Onix",15)
                          ,slot2: A2(encounter,"Zubat",17)
                          ,slot3: A2(encounter,
                          "Geodude",
                          17)
                          ,slot4: A2(encounter,
                          ...
                          "Geodude",
                          16)
                          ,slot6: A2(encounter,"Zubat",18)
                          ,slot7: A2(encounter,"Zubat",15)
                          ,slot8: A2(encounter,
                          "Machop",
                          17)
                          ,slot9: A2(encounter,
   ...
   var rockTunnelTable2 = {_: {}
                          ...
                          "Machop",
                          17)
                          ,slot8: A2(encounter,"Onix",17)
                          ,slot9: A2(encounter,
                          "Onix",
                          13)};
   var powerPlantTable = {_: {}
                         ,name: "Power Plant"
                         ,rate: 10
                         ,slot1: A2(encounter,
                         "Voltorb",
   ...
   var victoryRoadTable1 = {_: {}
                           ...
                           "Geodude",
                           26)
                           ,slot3: A2(encounter,"Zubat",22)
                           ,slot4: A2(encounter,"Onix",36)
                           ,slot5: A2(encounter,"Onix",39)
                           ,slot6: A2(encounter,"Onix",42)
                           ,slot7: A2(encounter,
                           "Graveler",
                           41)
                           ,slot8: A2(encounter,
   ...
   var victoryRoadTable3 = {_: {}
                           ...
                           26)
                           ,slot3: A2(encounter,"Zubat",22)
                           ,slot4: A2(encounter,"Onix",42)
                           ,slot5: A2(encounter,
                           "Venomoth",
                           40)
                           ,slot6: A2(encounter,"Onix",45)
                           ,slot7: A2(encounter,
                           "Graveler",
                           43)
                           ,slot8: A2(encounter,
   ...
   var pokemonTowerTable5 = {_: {}
                            ...
                            "Haunter",
                            28)};
   var seafoamIslandsTable1 = {_: {}
                              ,name: "Seafoam Islands (1F)"
                              ,rate: 15
                              ,slot1: A2(encounter,"Seel",30)
                              ,slot10: A2(encounter,
                              "Golduck",
                              38)
                              ,slot2: A2(encounter,
   ...
   var seafoamIslandsTable2 = {_: {}
                              ...
                              "Slowpoke",
                              28)
                              ,slot6: A2(encounter,"Seel",30)
                              ,slot7: A2(encounter,
                              "Slowpoke",
                              30)
                              ,slot8: A2(encounter,"Seel",28)
                              ,slot9: A2(encounter,
                              "Dewgong",
                              38)};
   var seafoamIslandsTable3 = {_: {}
   ...
   var seafoamIslandsTable4 = {_: {}
                              ...
                              "Dewgong",
                              37)
                              ,slot2: A2(encounter,"Seel",31)
                              ,slot3: A2(encounter,
                              "Slowpoke",
                              33)
                              ,slot4: A2(encounter,"Seel",33)
                              ,slot5: A2(encounter,
                              "Horsea",
                              29)
                              ,slot6: A2(encounter,
   ...
   var seafoamIslandsTable5 = {_: {}
                              ...
                              "Slowpoke",
                              29)
                              ,slot6: A2(encounter,"Seel",31)
                              ,slot7: A2(encounter,
                              "Slowpoke",
                              31)
                              ,slot8: A2(encounter,"Seel",29)
                              ,slot9: A2(encounter,
                              "Slowbro",
                              39)};
   var pokemonMansionTable1 = {_: {}
                              ,name: "Pokemon Mansion (1F)"
                              ,rate: 10
                              ,slot1: A2(encounter,
                              "Koffing",
                              32)
                              ,slot10: A2(encounter,"Muk",39)
                              ,slot2: A2(encounter,
                              "Koffing",
                              30)
                              ,slot3: A2(encounter,
                              ...
                              "Weezing",
                              37)};
   var pokemonMansionTable2 = {_: {}
                              ,name: "Pokemon Mansion (2F)"
                              ,rate: 10
                              ,slot1: A2(encounter,
                              "Growlithe",
                              32)
                              ,slot10: A2(encounter,"Muk",37)
                              ,slot2: A2(encounter,
                              "Koffing",
                              34)
                              ,slot3: A2(encounter,
                              ...
                              "Weezing",
                              39)};
   var pokemonMansionTable3 = {_: {}
                              ,name: "Pokemon Mansion (3F)"
                              ,rate: 10
                              ,slot1: A2(encounter,
                              "Koffing",
                              31)
                              ,slot10: A2(encounter,"Muk",42)
                              ,slot2: A2(encounter,
                              "Growlithe",
                              33)
                              ,slot3: A2(encounter,
   ...
   var safariZoneTable2 = {_: {}
                          ...
                          "Scyther",
                          28)
                          ,slot2: A2(encounter,"Doduo",26)
                          ,slot3: A2(encounter,"Paras",22)
                          ,slot4: A2(encounter,
                          "Exeggcute",
                          25)
                          ,slot5: A2(encounter,
   ...
   var ceruleanCaveTable3 = {_: {}
                            ...
                            "Raichu",
                            64)
                            ,slot7: A2(encounter,"Arbok",57)
                            ,slot8: A2(encounter,"Ditto",65)
                            ,slot9: A2(encounter,
                            "Ditto",
                            63)};
   ...
   _elm.Encounters.values = {_op: _op
                            ...
                            ,route13table: route13table
                            ,route14table: route14table
                            ,route15table: route15table
                            ,route16table: route16table
                            ,route17table: route17table
                            ,route18table: route18table
                            ,seaRoute19waterTable: seaRoute19waterTable
                            ,seaRoute20waterTable: seaRoute20waterTable
                            ,seaRoute21table: seaRoute21table
                            ,seaRoute21waterTable: seaRoute21waterTable
                            ,route22table: route22table
                            ,route23table: route23table
                            ,route24table: route24table
                            ,route25table: route25table
                            ,viridianForestTable: viridianForestTable
                            ,mtMoonTable1: mtMoonTable1
                            ,mtMoonTable2: mtMoonTable2
                            ,mtMoonTable3: mtMoonTable3
                            ,rockTunnelTable1: rockTunnelTable1
                            ,rockTunnelTable2: rockTunnelTable2
                            ,powerPlantTable: powerPlantTable
                            ,victoryRoadTable1: victoryRoadTable1
                            ,victoryRoadTable2: victoryRoadTable2
                            ,victoryRoadTable3: victoryRoadTable3
                            ,pokemonTowerTable1: pokemonTowerTable1
                            ,pokemonTowerTable2: pokemonTowerTable2
                            ,pokemonTowerTable3: pokemonTowerTable3
                            ,pokemonTowerTable4: pokemonTowerTable4
                            ,pokemonTowerTable5: pokemonTowerTable5
                            ,seafoamIslandsTable1: seafoamIslandsTable1
                            ,seafoamIslandsTable2: seafoamIslandsTable2
                            ,seafoamIslandsTable3: seafoamIslandsTable3
                            ,seafoamIslandsTable4: seafoamIslandsTable4
                            ,seafoamIslandsTable5: seafoamIslandsTable5
                            ,pokemonMansionTable1: pokemonMansionTable1
                            ,pokemonMansionTable2: pokemonMansionTable2
                            ,pokemonMansionTable3: pokemonMansionTable3
                            ,pokemonMansionTable4: pokemonMansionTable4
                            ,diglettsCaveTable: diglettsCaveTable
                            ,safariZoneTable1: safariZoneTable1
                            ,safariZoneTable2: safariZoneTable2
                            ,safariZoneTable3: safariZoneTable3
                            ,safariZoneTable4: safariZoneTable4
                            ,ceruleanCaveTable1: ceruleanCaveTable1
                            ,ceruleanCaveTable2: ceruleanCaveTable2
                            ,ceruleanCaveTable3: ceruleanCaveTable3};
   return _elm.Encounters.values;
};
Elm.Graph = Elm.Graph || {};
...
Elm.Main.make = function (_elm) {
   ...
   var calculateButton = A2($Html.input,
   _L.fromArray([$Html$Attributes.type$("button")
                ,A3($Html$Events.on,
                "click",
                $Json$Decode.value,
                ...
                ,$Html$Attributes.value("Calculate")]),
   _L.fromArray([]));
   ...
   function (state) {
      return function () {
         var _v10 = $Basics.snd(state);
         switch (_v10.ctor)
         {case "Done": return _v10._0;
            case "Unstarted":
            return _L.fromArray([]);
            case "Working":
            switch (_v10._0.ctor)
   ...
   function ($) {
      return $Maybe.withDefault(0.25)($Result.toMaybe($String.toFloat($)));
   },
   thresholdBox.signal);
   ...
   function (v) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([$Html.text("Threshold")
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.type$("text")
                                ,A3($Html$Events.on,
                                "keyup",
   ...
   $Html.div(_L.fromArray([])),
   combine(_L.fromArray([$Signal.constant(A2($Html.a,
                        _L.fromArray([$Html$Attributes.href("http://www.twitch.tv/extratricky/v/36891353")]),
                        _L.fromArray([$Html.text("How to use this calculator")])))
                        ,$interface
                        ,$Signal.constant(calculateButton)
                        ,thresholdInput
                        ,A2($Signal._op["<~"],
                        function ($) {
                           return $Html.fromElement(A2($Graph.drawGraph,
                           700,
                           400)($));
                        },
                        queryGraph)
                        ,A2($Signal.map,
                        function ($) {
                           return $Html.fromElement($Graphics$Element.show($));
                        },
                        strategy)
                        ,A2($Signal.map,
                        function ($) {
